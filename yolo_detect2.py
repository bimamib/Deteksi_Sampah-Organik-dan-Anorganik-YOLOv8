...
def main(image_directory, result_directory):
    ...
    for image_file in image_files:
        ...
        if confidences.size > 0:  # Check if there are any detections
            ...
            detection = {
                ...
                "time": {
                    "prep rocess": (end_preprocess - start_preprocess) * 1000, # untuk menghitung waktu pemrosesan unit microsecond ke millisecond
    ...
    result_path = os.path.join(result_directory, "result_normal.json")
