...
def calculate_metrics(detections, images_dir, labels_dir, class_names):
    ...
    return mAP, precision, recall, np.mean(ious), tp, fp, fn, tn, total_images, no_detections_count
...
mAP, precision, recall, average_iou, tp, fp, fn, tn, total_images, no_detections_count = calculate_metrics(detections, images_dir, labels_dir, class_names)
