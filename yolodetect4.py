...
def main(image_directory, result_directory):
    ...
    for image_file in image_files:
        ...
        # Ensure only one detection per image with the highest confidence
        if confidences.size > 0:  # Check if there are any detections
            ...
            detection = {
                ...
                "time": {
                    "preprocess": (end_preprocess - start_preprocess) * 1000, # unit: milliseconds
    ...
    result_path = os.path.join(result_directory, "result_normal4.json")
