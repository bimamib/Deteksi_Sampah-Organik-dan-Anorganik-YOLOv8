...
def calculate_metrics(detections, images_dir, labels_dir, class_names):
    ...
    for detection in detections:
        ...
        for label in true_labels:
            ...
            all_annotations.append({
                ...
                'bbox': true_box,
                'label_id': id(label)  # Unique ID for each annotation
            })
    ...
    for class_name in class_names:
        detections = [det for det in all_detections if det['class'] == class_name]
        annotations = [ann for ann in all_annotations if ann['class'] == class_name]
    ...
    return mAP, precision, recall, np.mean(ious), tp, fp, fn, tn, total_images
...
mAP, precision, recall, average_iou, tp, fp, fn, tn, total_images = calculate_metrics(detections, images_dir,
